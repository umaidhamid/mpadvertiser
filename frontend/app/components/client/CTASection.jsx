...
export default function CTASection() {
  ...
  const googleMapsLink =
    "https://maps.app.goo.gl/8mkpm5o7K3m6MEdk8";

  return (
    <section className="relative py-24 px-6 bg-background text-foreground border-t border-border overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          {/* Contact Card */}
          <div className="bg-card p-8 rounded-2xl border border-border space-y-6 shadow-sm">
        ...
        >
          ...
          >
            <div
              ...
              transition duration-500 group-hover:border-primary"
            >
              <iframe
